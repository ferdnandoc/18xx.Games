...
#
# TURNSTILE_SITEKEY/TURNSTILE_HOSTS are overridable via env so a self-hosted
# fork on its own domain can register its own free Turnstile keys instead of
# the ones registered for 18xx.games -- unset, behavior is identical to before.
TURNSTILE_SITEKEY = PRODUCTION ? (ENV['TURNSTILE_SITEKEY'] || '0x4AAAAAADuTm2-bvPUtb2pz') : '1x00000000000000000000AA'
...
TURNSTILE_HOSTS = (ENV['TURNSTILE_HOSTS'] || '18xx.games,www.18xx.games').split(',').freeze
